...
@section('content')
    ...
    <style>
        .category-banner .row {
            ...
            align-items: center;
            /* Menyusun item secara vertikal di tengah (opsional) */
            flex-wrap: wrap;
            /* Membuat elemen tetap responsif */
        }
    </style>
    ...
    <main>
        <section class="swiper-container js-swiper-slider swiper-number-pagination slideshow"
            ...
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide">
                    <div class="overflow-hidden position-relative h-100">
                        <div class="slideshow-character position-absolute bottom-0 pos_right-center">
                            <img loading="lazy" src="{{ asset('uploads/products') }}/{{ $new_product->image }}" width="542"
                                height="733" alt="{{ $new_product->name }}"
                        ...
                        <div class="slideshow-text container position-absolute start-50 top-50 translate-middle">
                            ...
                            <h2 class="h1 fw-bold animate animate_fade animate_btt animate_delay-5">{{ $new_product->name }}
                            </h2>
                            <a href="{{ route('shop.product.details', ['product_slug' => $new_product->slug]) }}"
                ...
                <!-- Gambar-gambar lainnya (dari explode) -->
                @foreach (explode(',', $new_product->images) as $gimg)
                    <div class="swiper-slide">
                        <div class="overflow-hidden position-relative h-100">
                            <div class="slideshow-character position-absolute bottom-0 pos_right-center">
                                <img loading="lazy" src="{{ asset('uploads/products') }}/{{ $gimg }}" width="542"
                                    height="733" alt="{{ $new_product->name }}"
                                    class="slideshow-character__img animate animate_fade animate_btt animate_delay-9 w-auto h-auto" />
                                <div class="character_markup type2">
                                    <p
        ...
        <div class="container mw-1620 bg-white border-radius-10">
            ...
            @if ($salesProduct->count() > 0)
                ...
                "1200": {
                    ...
                    "pagination": false
                                    ...
                                    <div class="swiper-wrapper">
                                        @forelse ($salesProduct as $sproduct)
                                            <div class="swiper-slide product-card product-card_style3">
                                                <div class="pc__img-wrapper">
                                                    <a
                                                        ...
                                                        <img loading="lazy"
                                                            src="{{ asset('uploads/products') }}/{{ explode(',', $sproduct->images)[1] ?? '' }}"
                                                            width="258" height="313" alt="{{ $sproduct->name }}"
            ...
            @if ($featuredProduct->count() > 0)
                <section class="category-banner container">
                    ...
                    <div class="row">
                        @forelse ($featuredProduct as $fproduct)
                            <div class="col-md-3">
                                <div class="category-banner__item border-radius-10 mb-5">
                                    <img loading="lazy" class="h-auto w-auto"
                                        src="{{ asset('uploads/products') }}/{{ $fproduct->image }}" height=""
                                        alt="" />
                                    <div class="category-banner__item-mark">
                                        Only
                                        @if ($fproduct->sale_price)
                                            Rp{{ number_format($fproduct->sale_price, 3, '.', '.') }}
                                        @else
                                            Rp{{ number_format($fproduct->regular_price, 3, '.', '.') }}
                                        @endif
                                    </div>
