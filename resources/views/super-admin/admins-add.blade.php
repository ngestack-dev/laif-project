                ...
                <div class="wg-box">
                    ...
                    <fieldset class="position">
                        ...
                        <input class="mb-10" type="text" placeholder="Enter position" name="position" tabindex="0"
                            value=" {{ old('position') }}" aria-required="true" required="">
                        <div class="text-tiny">Do not exceed 100 characters when entering the
                            position.</div>
                    </fieldset>
                    @error('position')
                    ...
                    <fieldset class="position">
                        <div class="body-title mb-10">Confirm Password <span class="tf-color-1">*</span>
                        </div>
                    ...
                    <div class="cols gap10">
                        <button class="tf-button w-full" type="submit">Add admin</button>
                    </div>
                </div>
            </form>
            <!-- /form-add-product -->
