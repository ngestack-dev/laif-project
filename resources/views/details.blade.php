        ...
        <section class="product-single container">
            <div class="row">
                ...
                <div class="col-lg-5">
                    ...
                    @else
                        @guest
                            <a href="{{ route('login') }}" class="btn btn-primary btn-addtocart mb-3 text-uppercase"
                                data-aside="cardDrawer">Login to add to cart</a>
                        @else
                                    ...
                                    <div class="product-card__price d-flex">
                                        <span class="money price">
                                            @if ($rproduct->sale_price)
                                                <s>Rp{{ number_format($rproduct->regular_price, 3, '.', '.') }}</s>
                                                Rp{{ number_format($rproduct->sale_price, 3, '.', '.') }}
                                            @else
                                                Rp{{ number_format($rproduct->regular_price, 3, '.', '.') }}
                                            @endif
                                        </span>
                                    </div>
                                </div>
